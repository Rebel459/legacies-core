...
/*		if (biomeGeneration.generateAridForest) {
		...
		//if (biomeGeneration.generateWarmRiver) {
			...
			Criterion temperature2 = CriterionBuilder.value(BiomeParameterTargets.TEMPERATURE, 0.55F, 1F);
			//if (biomePlacement.modifyJunglePlacement) {
				BiomePlacement.addSubOverworld(
					Biomes.RIVER,
					WWBiomes.WARM_RIVER,
			...
			//} else {
				//BiomePlacement.addSubOverworld(Biomes.RIVER, WWBiomes.WARM_RIVER, temperature2);
			//}
		//}
		...
		//if (biomeGeneration.generateTundra) {
			//if (!biomeGeneration.generateMapleForest) {
				...
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA, criterionA2);
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS, WWBiomes.TUNDRA, criterionA2);
				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA, criterionA2);
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS, WWBiomes.TUNDRA, criterionA2);

				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA, criterionB2);
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS, WWBiomes.TUNDRA, criterionB2);

				BiomePlacement.addSubOverworld(Biomes.PLAINS, WWBiomes.TUNDRA, criterionC2);
				BiomePlacement.addSubOverworld(Biomes.SNOWY_PLAINS, WWBiomes.TUNDRA, criterionC2);
			//}
		...
		//if (biomeGeneration.generateFrozenCaves) {
			for (float depth : FrozenCaves.DEPTHS) {
				Pair<Climate.ParameterPoint, Climate.ParameterPoint> biomeParameters = BiolithIntegration.INSTANCE.makeParametersAt(depth);
	...
	public static final BiolithIntegration INSTANCE = new BiolithIntegration();
